                ...
                <div class="checkout-wrapper">
                    <div id="faq" class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div id="my-account-1" class="panel-collapse collapse <?= isset($_POST['update_profile']) ? 'show' : ''; ?>">
                                            ...
                                            <form method="post">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="billing-info">
                                                        ...
                                                        }   // if (!empty($oldPasswordValidationResult['old_datebase'])) {   //    echo $oldPasswordValidationResult['old_datebase'] ;// } 
                                                        ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12">
                                ...
                                <div class="ml-auto mr-auto col-lg-9">
                                    <div class="checkout-wrapper">
                                        <div id="faq" class="panel-group">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title"><span>1</span> <a data-toggle="collapse" data-parent="#faq" href="#my-account-1">Edit your
